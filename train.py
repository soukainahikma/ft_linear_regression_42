...
reg1 = LinearRegression(n_iters=10000)
reg1.fit(X_train_scaled, y_train)
y_pred_line1 = reg1.predict(X_test_scaled)
print(reg.weight, reg.bias)

print(r2_score(y_test, y_pred_line))
...
plt.plot(X_test, y_pred_line1, color='green', linewidth=2, label='Prediction')
